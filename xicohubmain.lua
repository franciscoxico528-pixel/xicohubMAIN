...
local FolderName = "Xico Hub | Farm"
...
local Window = bearlib:MakeWindow({
    ...
    SubTitle = "by xicoszk",
    SaveFolder = true,
    Image = "rbxassetid://97827809493561"
})
...
-- =========================================================
-- AUTO FISHING SYSTEM (Ported from Xico Hub)
-- =========================================================
        ...
        pcall(function()
            while wait(Sec) do
                if _G.Auto_Rainbow_Haki then
                    -- Copy logic Rainbow Haki từ file Xico Hub.txt (dòng 2058-2154) vào đây nếu cần
